...
Produces certs/<name>_key.pem and certs/<name>_cert.pem
"""
...
def issue(name):
    ...
    cert = x509.CertificateBuilder()\
        ...
        .not_valid_before(datetime.datetime.datetime.utcnow() - datetime.timedelta(days=1))\
        .not_valid_after(datetime.datetime.datetime.utcnow() + datetime.timedelta(days=365))\
    ...
    print("Wrote:", os.path.join(OUT, f"{name}_key.pem"), os.path.join(OUT, f"{name}_cert.pem"))
